        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h2 className="text-2xl font-bold text-white mb-4">
              Learnify<span className="text-blue-400">AI</span>
            </h2>
            <p className="text-gray-400 mb-4 max-w-md">
              Transform your learning experience with AI-powered video analysis. 
              Get instant summaries, key insights, and interactive quizzes from any video content.
            </p>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} LearnifyAI. All rights reserved.
            </p>
          ...
          <p className="text-gray-500 text-xs text-center mt-4">
            Powered by AI • Made with ❤️ for learners worldwide
          </p>
        </div>
      </div>
    </footer>
